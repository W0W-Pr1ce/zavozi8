...
;(function ($, window, document, undefined) {
    ...
    var pluginName = "ultimateGDPR",
        defaults = {
            ...
            configure_mode: {
                ...
                dependencies: ['https://stackpath.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css', 'https://use.fontawesome.com/releases/v5.0.13/css/all.css'],
    ...
    $.extend(Plugin.prototype, {
        ...
        firstForm: function (ajax, buttonCount, license) {
            ...
            var localCookies = [];
            var externalCookies = [];
			license = '26d1dd0e-bd7d-4809-b367-823abbb97ebf';
                ...
                function (invocation) {
                    ...
                    if (self.checkCookie('gdprPlugin') === 'true' && groupedPlugin || (cookiesAllowed && groupedPlugin)) {
                        ...
                        if (cookieBlock) {
							...
							//if(invocation.arguments[0].src) {
							if ( (self.checkCookie('group_3') === 'true' && invocation.arguments[0].src == 'https://www.googletagmanager.com/gtm.js?id=GTM-N496LT') || 
								(self.checkCookie('group_3') === 'true' && invocation.arguments[0].src == 'https://www.google-analytics.com/analytics.js') || 
								(self.checkCookie('group_3') === 'true' && invocation.arguments[0].src && invocation.arguments[0].src.match('^https://www.googleadservices.com/')) || 
								(self.checkCookie('group_4') === 'true' && invocation.arguments[0].src && invocation.arguments[0].src.match('^https://googleads.g.doubleclick.net/')) || 
								(self.checkCookie('group_4') === 'true' && invocation.arguments[0].src == 'https://connect.facebook.net/en_US/fbds.js') || 
								(self.checkCookie('group_4') === 'true' && invocation.arguments[0].src == 'https://mc.yandex.ru/metrika/watch.js') || 
								(self.checkCookie('group_4') === 'true' && invocation.arguments[0].src && invocation.arguments[0].src.match('^https://static.hotjar.com/')) || 
								(self.checkCookie('group_4') === 'true' && invocation.arguments[0].src && invocation.arguments[0].src.match('^https://script.hotjar.com/')) || 
								(self.checkCookie('group_4') === 'true' && invocation.arguments[0].src && invocation.arguments[0].src.match('^https://ajax.googleapis.com/ajax/')) || 
								(self.checkCookie('group_4') === 'true' && invocation.arguments[0].src && invocation.arguments[0].src.match('^https://connect.facebook.net/')) || 
								(self.checkCookie('group_4') === 'true' && invocation.arguments[0].src && invocation.arguments[0].src.match('^https://track.adform.net/')) ) {
								if (debug) {
									console.log('[ultimate gdpr1] cookie allowed: ' + invocation.arguments[0].src);
								}
							...
							//}
								...
								if (debug) {
									console.log('[ultimate gdpr1] cookie blocked: ' + invocation.arguments[0].src);
								}
            ...
            try {
                ...
                Object.defineProperty(document, 'cookie', {
                    ...
                    set: function set(val) {
						...
						if( (self.checkCookie('group_3') === 'true' && name == '_ga') || 
							(self.checkCookie('group_3') === 'true' && name == '_gid') || 
							(self.checkCookie('group_3') === 'true' && name == '_dc_gtm_UA-217674-8') || 
							(self.checkCookie('group_4') === 'true' && name == '_gcl_au') || 
							(self.checkCookie('group_4') === 'true' && name == 'metrika_enabled') || 
							(self.checkCookie('group_4') === 'true' && name == '_ym_metrika_enabled') || 
							(self.checkCookie('group_4') === 'true' && name == '_hjTLDTest') || 
							(self.checkCookie('group_4') === 'true' && name == '_hjid') || 
							(self.checkCookie('group_4') === 'true' && name == '_fbp') || 
							(self.checkCookie('group_3') === 'true' && name == '_ym_uid') || 
							(self.checkCookie('group_3') === 'true' && name == '_ym_d') || 
							(self.checkCookie('group_5') === 'true' && name == '_ym_metrika_enabled_42297224') || 
							(self.checkCookie('group_3') === 'true' && name == '_ym_isad') || 
							(self.checkCookie('group_5') === 'true' && name == '_ym_mp2_substs_42297224') ) {
							this._value = val;
							ct_ultimate_gdpr_cookie_setter_original && ct_ultimate_gdpr_cookie_setter_original.apply(document, arguments);
							if (debug) {
							console.log("[ultimate gdpr] cookie allowed: " + name);
							}
						}
						else {
        ...
        onAcceptPopup: function () {
            ...
            $('#ct-ultimate-gdpr-cookie-accept').on('click', function () {
                for (var key in popupOptions.cookies_groups) {
                    ...
                    if ($currentGroup.parent().hasClass('ct-ultimate-gdpr-cookie-modal-slider-item--active') || $currentGroup.parent().hasClass('ct-ultimate-gdpr-cookie-modal-slider-item--selected')) {
						...
						$currentGroup.parent().addClass('ct-ultimate-gdpr-cookie-modal-slider-item--active');
                        document.cookie = key + '=true' + self.cookieProperties;
                    }
                }
                //var groupSelected = $('.ct-ultimate-gdpr-cookie-modal-slider-item--active input').data('count');
				...
				self.aopAround(document.getElementsByTagName('script')[0].parentNode, "insertBefore");
                self.aopAround(document.getElementsByTagName('script')[0].parentNode, "appendChild");
				self.settings.popup_options.third_party_cookies_whitelist = 'https://www.googletagmanager.com/gtm.js?id=GTM-N496LT';
			...
			$('#ct-ultimate-gdpr-cookie-reject').on('click', function () {
                for (var key in popupOptions.cookies_groups) {
                    var $currentGroup = $('#' + key);
        ...
        popUpBox: function () {
            ...
            if (popupOptionStyle.position === 'top-panel') {
                if (popupOptionStyle.box_skin === 'skin-dark-theme') {
                    popup.append('<div class="ct-container ct-ultimate-gdpr-cookie-popup-topPanel"><img src="' + popupOptions.assets_path + '/images/dark-cookie-icon.png" class="ct-skin-dark-icon"/>' + headerPopup + '<div id="ct-ultimate-gdpr-cookie-content">' + popupOptions.popup_text + '</div></div>');
                } else if (popupOptionStyle.box_skin === 'skin-light-theme') {
                    popup.append('<div class="ct-container ct-ultimate-gdpr-cookie-popup-topPanel"><div class="ct-skin-light-icon"><img src="' + popupOptions.assets_path + '/images/light-cookie-icon.png"/></div>' + headerPopup + '<div id="ct-ultimate-gdpr-cookie-content">' + popupOptions.popup_text + '</div></div>');
                } else {
                ...
                if (popupOptionStyle.box_skin === 'skin-dark-theme') {
                    popup.append('<div class="ct-container ct-ultimate-gdpr-cookie-popup-bottomPanel"><div class="gdpr-cookie-popup-left"><img src="' + popupOptions.assets_path + '/images/dark-cookie-icon.png" class="ct-skin-dark-icon"/>' + headerPopup + '<div id="ct-ultimate-gdpr-cookie-content">' + popupOptions.popup_text + '</div></div></div>');
                }else if(popupOptionStyle.box_skin === 'skin-light-theme'){
                    popup.append('<div class="ct-container ct-ultimate-gdpr-cookie-popup-bottomPanel"><div class="ct-skin-light-icon"><img src="' + popupOptions.assets_path + '/images/light-cookie-icon.png"/></div>' + headerPopup + '<div id="ct-ultimate-gdpr-cookie-content">' + popupOptions.popup_text + '</div></div>');
                }else{
                ...
                if (popupOptionStyle.box_skin === 'skin-light-theme') {
                    popup.append('<div class="ct-skin-light-icon"><img src="' + popupOptions.assets_path + '/images/light-cookie-icon.png"/></div>');
                }
                if (popupOptionStyle.box_skin === 'skin-dark-theme') {
                    popup.append('<div class="ct-skin-dark-icon"><img src="' + popupOptions.assets_path + '/images/dark-cookie-icon.png"/></div>');
                }
			...
			if (popupOptions.reject_button_text) {
				var $rejectButton = $('<div id="ct-ultimate-gdpr-cookie-reject"> ' + popupOptions.reject_button_text + '</div>');
			}
        ...
        popupModal: function () {
			...
			var cookieGroup = [self.checkCookie('group_1'), self.checkCookie('group_2'), self.checkCookie('group_3'), self.checkCookie('group_4'), self.checkCookie('group_5')];
            ...
            var $form = $('<form action="#" id="ct-ultimate-gdpr-cookie-modal-slider-form"><div class="ct-ultimate-gdpr-slider"></div><div class="ct-ultimate-gdpr-cookie-elements-body"> </div></form>');
            ...
            Object.keys(cookiesGroups).forEach(function (element, i, array) {
				...
				if(i == '0'){
					var $listItem = $('<div class="cli-tab-pane"><div class="cli-tab-panel-header"><h4>Enable All Cookies</h4><label class="cli-switch switch-group-all-cookies"><input type="checkbox" class="cli-user-preference-checkbox ct-ultimate-gdpr-cookie-modal-slider-radio" id="group_all" data-id="group_all" name="radio-group" /><span class="cli-slider"></span></label></div><div class="cli-clearboth"></div></div>');
						
						
					$form.find('.ct-ultimate-gdpr-cookie-elements-body').append($listItem);
				}

                if (thisGroup.enable) {

                    if ((cookiesSet !== 'true' && element === popupOptions.default_group ) || cookieGroup[i] == 'true' || i == '0') {
						...
						var $listItem = $('<div class="cli-tab-pane"><div class="cli-tab-panel-header"><h4>' + thisGroup.name + '</h4><label class="cli-switch switch-group-' + thisGroup.name + ' ct-ultimate-gdpr-cookie-modal-slider-item--selected"><input type="checkbox" class="cli-user-preference-checkbox ct-ultimate-gdpr-cookie-modal-slider-radio" data-count="' + parseInt(i + 1) + '" id="group_' + parseInt(i + 1) + '" data-id="group_' + parseInt(i + 1) + '" name="radio-group" checked /><span class="cli-slider"></span></label></div><div class="cli-clearboth"></div><div>' + thisGroup.list[0] + '</div><div class="cli-clearboth"></div><div><div class="cookie_show" data-cookieid="' + thisGroup.name + '">View ' + thisGroup.name + ' <span class="cookie-icon" ></span></div><div class="hidden-list-cookies ' + thisGroup.name + '-list"><table class="cookielawinfo-classic cookielawinfo-row-cat-table"><thead><tr><th class="cookielawinfo-column-1">Cookie</th><th class="cookielawinfo-column-2">Type</th><th class="cookielawinfo-column-3">Duration</th><th class="cookielawinfo-column-4">Description</th></tr></thead><tbody class="list-cookie-group-items"></tbody></table></div></div><div class="cli-clearboth"></div></div>');
						
						$.each( thisGroup.local_cookies_name, function( i, val ) {
							var $listCookieGroupItem = '<tr class="cookielawinfo-row"><td class="cookielawinfo-column-1">' + val + '</td><td>' + thisGroup.local_cookies_type[i] + '</td><td>' + thisGroup.local_cookies_duration[i] + '</td><td>' + thisGroup.local_cookies_description[i] + '</td></tr>';
 
							$listItem.find('.list-cookie-group-items').append($listCookieGroupItem);
						});
						...
						var $listItem = $('<div class="cli-tab-pane"><div class="cli-tab-panel-header"><h4>' + thisGroup.name + '</h4><label class="cli-switch switch-group-' + thisGroup.name + '"><input type="checkbox" class="cli-user-preference-checkbox ct-ultimate-gdpr-cookie-modal-slider-radio" data-count="' + parseInt(i + 1) + '" id="group_' + parseInt(i + 1) + '" data-id="group_' + parseInt(i + 1) + '" name="radio-group" /><span class="cli-slider"></span></label></div><div class="cli-clearboth"></div><div>' + thisGroup.list[0] + '</div><div class="cli-clearboth"></div><div><div class="cookie_show" data-cookieid="' + thisGroup.name + '">View ' + thisGroup.name + ' <span class="cookie-icon" ></span></div><div class="hidden-list-cookies ' + thisGroup.name + '-list"><table class="cookielawinfo-classic cookielawinfo-row-cat-table"><thead><tr><th class="cookielawinfo-column-1">Cookie</th><th class="cookielawinfo-column-2">Type</th><th class="cookielawinfo-column-3">Duration</th><th class="cookielawinfo-column-4">Description</th></tr></thead><tbody class="list-cookie-group-items"></tbody></table></div></div><div class="cli-clearboth"></div></div>');
